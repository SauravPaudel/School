  ...
  return (
    <div className='container mx-auto pt-10'>
      ...
      <div className="flex justify-between h-full gap-6">
        <div className="w-1/3 h-[900px] relative overflow-hidden">
          <img
    ...
    {/* Crad  */}
    <div className='flex-col relative top-14 left-8 pt-20  max-h-[400px] '>
          <span className='text-black font-bold text-2xl'>Extra Curricular Activities</span><br></br>
          </div>
    ...
    <div className="w-full h-[70vh] flex text-[#162545] justify-center items-center relative bottom-20">
      <div className="w-1/2 p-4">
        <div className="relative">
          <img
            src="https://via.placeholder.com/600x400"
