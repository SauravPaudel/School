...
const Home = () => {
  ...
  return (
    <div className="relative w-full">
      ...
      {/* Hero Section */}
      <div className="flex flex-col items-center justify-center min-h-screen py-20 md:flex-row">
        <div className="flex flex-col justify-center w-full gap-4 text-center">
          <p className="text-4xl text-[#162545] md:text-7xl capitalize font-semibold">
