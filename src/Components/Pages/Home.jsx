...
const Home = () => {
    ...
    <div className="flex flex-col  mr-4 md:flex-row sm:justify-center sm:pt-20 items-center py-7  ">
      <div className="flex flex-col gap-4 ">
        <p className="text-4xl text-[#162545]  relative left-20 sm:text-7xl capitalize font-semibold sm:flex gap-1 ">
          ...
          <br />
          <span className="text-[#162545] pl-2 capitalize">Vidhya</span>{" "}
          Mandir <br />{" "}
        </p>
  ...
  <div className="flex gap-32 justify-center items-center mb-4">
    <div className="flex flex-col items-center hover:text-blue-500 transition duration-300 ml-8">
      ...
      <span className="text-white text-center font-bold">20+ Years of Excellence</span>
    </div>
    ...
    <div className="flex flex-col items-center hover:text-blue-500 transition duration-300">
      ...
      <span className="text-white text-center">20+ Teaching Staffs</span>
    </div>
    <div className="flex flex-col items-center hover:text-blue-500 transition duration-300 mr-8">
      ...
      <span className="text-white text-center">50+ Rewards</span>
    </div>
  </div>
</div>
      ...
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20">
        ...
        <div className="bg-white rounded-lg shadow-md transition duration-300 hover:shadow-lg ">
          ...
          <div className="pt-[24px]">
            ...
            <h3 className='text-1xl font-bold className="text-black flex items-center ml-2 transition duration-300 pt-4'>- Madan Malla</h3>
            {/* <a
              href="#"
        ...
        <div className="bg-white rounded-lg shadow-md transition duration-300 hover:shadow-lg">
          ...
          <div className="p-6">
            ...
            <h3 className='text-1xl font-bold className="text-black flex items-center ml-2 transition duration-300 pt-4'>- Dunika Bhushal</h3>
            {/* <a
              href="#"
